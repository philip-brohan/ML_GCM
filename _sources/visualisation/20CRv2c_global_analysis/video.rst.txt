...
.. literalinclude:: ../../../visualisation/20CRv2c_global_analysis/make_frames.py
...
.. code-block:: bash
    ...
    ffmpeg -r 24 -pattern_type glob -i 20CRv2c_global_4var/\*.png \
           -c:v libx264 -threads 16 -preset veryslow -tune film \
           -profile:v high -level 4.2 -pix_fmt yuv420p -b:v 5M \
           -maxrate 5M -bufsize 20M -c:a copy 20CRv2c_global_4var.mp4
